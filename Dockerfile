...
RUN apk add --no-cache git python3 ca-certificates && \
    ...
    pip3 install --no-cache-dir home-assistant-frontend==20180130.0 user-agents==1.1.0 sqlalchemy==1.2.1 distro==1.2.0 aiohttp_cors==0.6.0 jsonrpc-async==0.6 samsungctl==0.6.0 pychromecast==1.0.3 paho-mqtt==1.3.1 rxv==0.5.1 jsonrpc-websocket==0.5 wakeonlan==0.2.2 websocket-client==0.37.0 && \
