...
RUN mkdir /data && \
    ...
    pip install --no-cache-dir --trusted-host https://pypi.python.org sqlalchemy==1.1.5 distro==1.0.2 aiohttp_cors==0.5.0 gTTS-token==1.1.1 astral==1.3.3 fuzzywuzzy==0.14.0 xmltodict==0.10.2 netdisco==0.8.1 jsonrpc-async==0.2 samsungctl==0.6.0 pychromecast==0.7.6 paho-mqtt==1.2 pwaqi==1.4 rxv==0.4.0 && \
